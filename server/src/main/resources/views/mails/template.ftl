<!--
Mail template based on StackOverflow: https://stackoverflow.design/email/guidelines/getting-started/
-->
                ...
                <tr>
                    <td style="padding: 20px 30px; text-align: left;" class="sm-px">
                        <a href="https://stackoverflow.com/">
                            <img src="Logo@2x.png" alt="Stack Overflow logo." border="0" height="36" width="146"
                                 style="display: block; font-family: arial, sans-serif; font-size: 15px; line-height: 15px; color: #3C3F44; margin: 0;">
                        </a>
                    </td>
                </tr>
                <!-- Logo : END -->
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                                        <tr>
                                            <td valign="middle" height="19" width="19"
                                                style="font-family: arial, sans-serif; font-size: 13px; line-height: 13px; color: #ffffff; background-color: #EB5757; font-weight: bold; text-align: center; border-radius: 3px;">
                                                S
                                            </td>
                                            <td valign="middle"
                                                style="padding-left: 5px; font-family: arial, sans-serif; font-size: 13px; line-height: 13px; color: #242729; text-align: left;">
                                                SO for Teams Name
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td style="padding-bottom: 15px; font-family: arial, sans-serif; font-size: 15px; line-height: 21px; color: #3C3F44; text-align: left;">
                                    <h1 style="font-weight: bold; font-size: 27px; line-height: 27px; color: #0C0D0E; margin: 0 0 15px 0;">
                                        Something happened</h1>
                                    <p style="margin: 0 0 15px;" class="has-markdown">A starting point for more <strong>simple
                                            transactional emails</strong> with a single message. It can contain <a
                                                href="#"
                                                style="color: #0077CC; text-decoration: none;">links</a>
                                        or <strong>rich</strong> <em>text</em>. <a
                                                href="https://stackoverflow.design/email/base/typography#links-in-markdown"
                                                target="_parent" style="color: #0077CC; text-decoration: none;">Read
                                            this</a> if text is written in markdown.</p>
                                    <p style="margin: 0 0 15px;">Good for emails like:</p>
                                    <ul style="padding: 0; margin: 0; list-style-type: disc;">
                                        <li style="margin:0 0 10px 30px;">Forgot password</li>
                                        <li style="margin:0 0 10px 30px;">You’ve been removed from a Team</li>
                                        <li style="margin:0 0 10px 30px;">Cart abandonment</li>
                                        <li style="margin:0 0 10px 30px;">We've updated our privacy policy</li>
                                    </ul>
                                </td>
                            </tr>
                            <!-- Rich Text : END -->
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td class="s-btn s-btn__filled"
                                                style="border-radius: 4px; background: #0095ff;">
                                                <a class="s-btn s-btn__filled"
                                                   href="https://stackoverflow.design/email/components/buttons"
                                                   target="_parent"
                                                   style="background: #0095FF; border: 1px solid #0077cc; box-shadow: inset 0 1px 0 0 rgba(102,191,255,.75); font-family: arial, sans-serif; font-size: 17px; line-height: 17px; color: #ffffff; text-align: center; text-decoration: none; padding: 13px 17px; display: block; border-radius: 4px; white-space: nowrap;">Medium
                                                    filled button</a>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            ...
                            <tr>
                                <td style="font-size: 12px; line-height: 15px; font-family: arial, sans-serif; color: #9199A1; text-align: left;">
                                    ...
                                    <a href="https://stackoverflow.com/company/contact"
                                       style="color: #9199A1; text-decoration: underline;">Contact us</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="Urls.Legal.PrivacyPolicy"
                                       style="color: #9EA3A9; text-decoration: underline;">Privacy</a>
                                </td>
                            </tr>
                            <!-- Subscription Info : BEGIN -->
                            <!-- HR line : BEGIN -->
                            ...
                            <tr>
                                <td style="padding-bottom: 5px; text-align: left;">
                                    <img src="LogoSm@2x.png" align="left" alt="" border="0" width="111" height="22"
                                         style="display: block; font-family: arial, sans-serif; font-size: 12px; line-height: 12px; color: #3C3F44;">
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom: 5px; font-size: 12px; line-height: 15px; font-family: arial, sans-serif; color: #9199A1; text-align: left;">
                                    <strong>Stack Overflow</strong>, <span class="unstyle-auto-detected-links">110 William Street, 28th Floor, New York, NY 10038</span>
                                </td>
                            </tr>
                            <!-- Sender Info : END -->
                            <!-- Heart : BEGIN -->
                            <tr>
                                <td>
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                           style="background:#ffffff; border-radius:1px; line-height:0px">
                                        <tr>
                                            <td>
                                                <div style="border-radius: 1px; border: 1px solid #D6D9DC; padding: 4px 6px 3px 6px; font-size: 11px; line-height: 11px; font-family: Consolas, monospace; color: #E06C77;"
                                                     title="because we care">&lt;3
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
